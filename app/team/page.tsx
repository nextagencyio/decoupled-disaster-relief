...
export const metadata: Metadata = {
  title: 'Our Team | First Response Alliance',
  description: 'Meet the dedicated professionals behind First Response Alliance.',
}
      ...
      <section className="relative bg-gradient-to-r from-primary-800 via-primary-900 to-primary-800 text-white py-16 md:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Our Team</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {items.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">Team Members will appear here once content is imported.</p>
            </div>
          ) : (
