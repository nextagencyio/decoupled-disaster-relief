...
export const metadata: Metadata = {
  title: 'Contact Us | First Response Alliance',
  description: 'Contact First Response Alliance about disaster relief, volunteering, or making a donation.',
}
      ...
      <section className="relative bg-gradient-to-r from-primary-800 via-primary-900 to-primary-800 text-white py-16 md:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-primary-200 max-w-3xl mx-auto">
            Have questions about volunteering, donating, or our relief operations? We&#39;d love to hear from you.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@firstresponsealliance.org</p>
                    <p className="text-gray-600">volunteer@firstresponsealliance.org</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-primary-100 to-accent-100 rounded-xl flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(202) 555-0147</p>
                    <p className="text-sm text-gray-500">Emergency Hotline: 24/7</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-primary-100 to-accent-100 rounded-xl flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">750 Relief Coordination Drive<br />Washington, DC 20001</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-primary-100 to-accent-100 rounded-xl flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Mon - Fri: 8:00 AM - 6:00 PM<br />Emergency Hotline: 24/7</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-8">
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <textarea id="message" name="message" rows={6} className="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500" placeholder="Tell us how we can help..." required />
                </div>
          ...
          <div className="mt-8 md:mt-12 bg-gradient-to-br from-primary-50 to-accent-50 rounded-xl p-6 md:p-8">
            <div className="text-center">
              <h2 className="font-display text-xl md:text-2xl font-bold text-gray-900 mb-4">Emergency? Call Our 24/7 Hotline</h2>
              <p className="text-sm md:text-base text-gray-600 mb-6">
                If you are experiencing an emergency or need immediate assistance, contact our emergency response line.
              </p>
